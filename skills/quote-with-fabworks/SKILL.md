...
description: Create and manage Fabworks manufacturing quotes through the Fabworks MCP server. Use when a user asks an agent to quote STEP files, find Fabworks materials or finishes, review quote pricing or DFM results, update quote parts, list recent quotes, or check a Fabworks order.
---
